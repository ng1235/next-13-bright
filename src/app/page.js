...
function Home() {
  return (
    <main>
      ...
      <Revealable>{<Snippet>{FIRST_SNIPPET}</Snippet>}</Revealable>
      ...
      <Revealable>{<Snippet>{SECOND_SNIPPET}</Snippet>}</Revealable>
      ...
      <Revealable>{<Snippet>{THIRD_SNIPPET}</Snippet>}</Revealable>
    </main>
  );
}
